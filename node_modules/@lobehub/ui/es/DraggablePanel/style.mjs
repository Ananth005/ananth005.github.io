...
const useStyles = createStyles(({ prefixCls, token }, { backgroundColor, headerHeight, showBorder, showHandleWideArea }) => {
    ...
    `;
	const handleStyles = {
		handleBottom: cx(`${prefix}-bottom-handle`, css`
          &::before {
            inset-block-end: 50%;
            width: 100%;
            height: 2px;
        ...
        `),
		handleLeft: cx(`${prefix}-left-handle`, css`
          &::before {
        ...
        `),
		handleRight: cx(`${prefix}-right-handle`, css`
          &::before {
            inset-inline-end: 50%;
            width: 2px;
            height: 100%;
		...
		handleTop: cx(`${prefix}-top-handle`, css`
          &::before {
	...
	const toggleBaseStyle = cx(`${prefix}-toggle`, css`
