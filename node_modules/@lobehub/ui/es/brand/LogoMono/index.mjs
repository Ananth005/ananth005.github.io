...
//#region src/brand/LogoMono/index.tsx
const LogoMono = ({ size = "1em", style, ...rest }) => {
	return /* @__PURE__ */ jsxs("svg", {
		...
		...rest,
		children: [
			/* @__PURE__ */ jsx("title", { children: "LobeHub" }),
			/* @__PURE__ */ jsx("path", {
...
var LogoMono_default = LogoMono;

//#endregion
export { LogoMono_default as default };
